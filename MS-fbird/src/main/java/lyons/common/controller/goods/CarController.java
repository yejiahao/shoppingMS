...
public class CarController extends BaseController {
     ...
     * @return: String
     */
    @RequestMapping(value = "/carDelete", method = RequestMethod.POST, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
     ...
     * @return: String
     */
    @RequestMapping(value = "/carAdd", method = RequestMethod.POST, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
