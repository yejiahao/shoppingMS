...
public class GOrder {
    ...
    public GOrder(int gOrderId, String gOrderUName, int gOrderGId, double gOrderPrice, int gOrderNumber, Date gOrderCreateDate, String receiver, String gOrderPhone, String gOrderAddress) {
