...
<center><br><br>
    ...
    <a href="${pageContext.request.contextPath}/goodsDao?key=4"><span style="color: red; font-size: xx-large">购物</span></a>
    <%
            return;
        }
    %>
    ...
    <table cellpadding="10" cellspacing="0" width="400" height="80">
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/jsp/browse/showGoods.jsp">
